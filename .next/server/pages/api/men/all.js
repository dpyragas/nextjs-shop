...
(function() {
var exports = {};
exports.id = "pages/api/men/all";
exports.ids = ["pages/api/men/all"];
exports.modules = {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": function() { return /* binding */ getAllProductsByMale; }\n/* harmony export */ });\n/* harmony import */ var _db_init_db__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../db/init-db */ \"./db/init-db.ts\");\n\nasync function getAllProductsByMale(req, res) {\n  const {\n    db\n  } = (0,_db_init_db__WEBPACK_IMPORTED_MODULE_0__.getDB)();\n  const result = await db.query('SELECT id,\"name\",gender,price,category, img FROM shop.products WHERE gender = $1', 'men');\n  res.status(200).json(result);\n}//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./pages/api/men/all/index.ts\n");
...
var __webpack_exports__ = (__webpack_exec__("./pages/api/men/all/index.ts"));
