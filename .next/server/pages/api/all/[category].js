...
(function() {
var exports = {};
exports.id = "pages/api/all/[category]";
exports.ids = ["pages/api/all/[category]"];
exports.modules = {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": function() { return /* binding */ getProductsByCategory; }\n/* harmony export */ });\n/* harmony import */ var _db_init_db__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../db/init-db */ \"./db/init-db.ts\");\n\nasync function getProductsByCategory(req, res) {\n  const {\n    db\n  } = (0,_db_init_db__WEBPACK_IMPORTED_MODULE_0__.getDB)();\n  const {\n    category\n  } = req.query;\n  const result = await db.query('SELECT id,\"name\",price, gender, img, category FROM shop.products WHERE category = $1 ', category);\n  res.status(200).json(result);\n}//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./pages/api/all/[category].ts\n");
...
var __webpack_exports__ = (__webpack_exec__("./pages/api/all/[category].ts"));
